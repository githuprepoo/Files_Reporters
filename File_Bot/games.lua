...
if text == 'الالعاب' and ChCheck(msg) and database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Text_Games = [[
✯︙اوامر الالعاب كتالي 
•━━━━━━━━━━━━━•ٴ
...
if text == 'اسرع' and ChCheck(msg) or text == 'الاسرع' and ChCheck(msg) or text == 'ترتيب' and ChCheck(msg) then
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
if text == 'خمن' and ChCheck(msg) or text == 'التخمين' and ChCheck(msg) or text == 'تخمين' and ChCheck(msg) then   
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
...
if text == 'تعطيل الالعاب' and ChCheck(msg) and Manager(msg) then   
if database:get(bot_id..'Lock:Games'..msg.chat_id_)  then
...
if text == 'تفعيل الالعاب' and ChCheck(msg) and Manager(msg) then  
