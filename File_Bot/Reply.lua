...
TextReply = 'عليكم السلام نورت يكلبي'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام وانت' then
TextReply = 'اني بالنسبه الي داشر اسئل الباقي '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام وانتي ' then
TextReply = 'جذاب وين اكو احد بخير '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
if text == ' ت خ ' then
TextReply = 'هسه تعالي خاص مدري تصبح على خير '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هه' then
TextReply = 'دوم الضحكه يروحي'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'ههه' then
...
if text == 'مرحبا ' then
TextReply = 'مراحب نورت كروبنا '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اجيت ' then
TextReply = 'ها ها ين جنت طامس'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'عرفنا ' then
TextReply = 'وياك قاهر البنات العمر ١٠٠'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تصبحون على خير ' then
TextReply = 'تعال خلينا متونسين '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شويه وارجع' then
TextReply = 'شي اكيد راح تطمس'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😡' then
...
if text == '😡😡' then
TextReply = 'لاصدك متخوف بابا'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😡😡😡' then
TextReply = 'شبيك صاير عصبي'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شكو ماكو' then
TextReply = 'غيرك بالكلب ماكو'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'احبج' then
...
if text == 'حلو ' then
TextReply = '  حلاتك يروحي '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اكلك ' then
TextReply = 'كلي وماكول لحد '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تزوجني ' then
...
if text == 'تحبني ' then
TextReply = 'شي اكيد انتي النفس مالي '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'زعلت ' then
TextReply = 'متزعل أحد كاضبك'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'امم' then
